    ...
    <footer className="bg-caribbean-deep-blue text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="space-y-2 text-blue-100 mb-4">
              <p>
                <a 
                  href="https://wa.me/18292082246" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="hover:text-white transition-colors"
                >
                  📱 WhatsApp: +1 829 208 2246
                </a>
              </p>
            </div>
            <div className="flex gap-4 mt-4">
              <a
                href="https://www.instagram.com/isla__saona/"
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a
                href="https://www.facebook.com/profile.php?id=100090917702537&ref=pro_upsell_xav_ig_profile_page_web#"
                target="_blank"
                rel="noopener noreferrer"
                className="text-blue-100 hover:text-white transition-colors"
                aria-label="Facebook"
        ...
        <div className="border-t border-blue-700 mt-8 pt-8 text-center text-blue-100">
          <p>© {currentYear} Isla 🌴 Saona - {t('allRightsReserved')}</p>
        </div>
      </div>
    </footer>
  )
